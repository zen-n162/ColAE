...
# %% ファイルの読み込み
data_name_s= ['Tokyo', 'Port']

# %% 変更する値
#file_path_s = ['../Dataset/M3/Schrodinger_2/data/Schrodinger_2/Schrodinger_2_norm_750_2.tif', # Prepro 3
...
# %%
for data_name in data_name_s:
    save_path = data_name+'/' # Port/
    for L in L_s:
        img_save_path = save_path+'/'+data_name+'_DR_'+str(L)+'.tif'
        weight_path = save_path+'/weight_'+str(L)


        file_path = f'../Dataset/HISUI/{data_name}/{data_name}.tif'

        print(f'save_path: {save_path}, L: {L}')
